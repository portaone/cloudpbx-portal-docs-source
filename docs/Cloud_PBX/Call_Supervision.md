...
Cloud PBX managers can supervise their colleagues' calls in real time. For example, a manager can listen in on a sales agent's calls, guide them, and, if needed, participate in the calls.
...
![](./img/Call_Supervision/Call_supervision-Call_supervision_overview.png)
...
![](./img/Call_Supervision/Call_supervision-Add_supervisors_to_groups.png)
...
![](./img/Call_Supervision/Call_supervision-Current_calls.png)
...
## Switching Call Supervision Modes
